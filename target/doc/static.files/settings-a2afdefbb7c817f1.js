...
(function () {
    ...
    function showLightAndDark() {
        removeClass(
            document.getElementById("preferred-light-theme").parentElement,
            "hidden",
        );
        removeClass(
            document.getElementById("preferred-dark-theme").parentElement,
            "hidden",
        );
    }
    ...
    function setEvents(settingsElement) {
        ...
        onEachLazy(
            settingsElement.getElementsByClassName("select-wrapper"),
            (elem) => {
...
<div class="choices">`;
                onEach(setting["options"], (option) => {
                    const checked =
                        option === setting["default"] ? " checked" : "";
...
<label class="settings-toggle">\
    ...
    function buildSettingsPage() {
        const theme_names = getVar("themes")
            .split(",")
            .filter((t) => t);
        ...
        const innerHTML = `<div class="settings">${buildSettingsPageSections(
            settings,
        )}</div>`;
