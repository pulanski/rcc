...
//     assert_eq!(super::process_str("AFooB", &mut context).unwrap(),
// "AFooB\n");     assert_eq!(super::process_str("Foo_", &mut context).unwrap(),
// "Foo_\n");     assert_eq!(super::process_str("_Foo", &mut context).unwrap(),
// "_Foo\n");     assert_eq!(super::process_str("One Foo Two", &mut
// context).unwrap(), "One Bar Two\n"); }
...
// //   assert_eq!(
// //     crate::process_str("$Foo", &mut context).unwrap(),
// //     "1\n"
// //   );
// //   assert_eq!(
...
//     let expected_path =
// format!("testdata/preprocessor/{filename}/expected.c");     let expected =
// std::fs::read_to_string(expected_path).unwrap();     assert_eq!(text,
// expected); }

// // #[rstest]
// // #[case::variadic_macro("variadic_macro.c")]
// // fn preprocess_variadic_macro(#[case] filename: &str) {
// //   // For each test case, create a new context and process the file.
// //   let file_path = format!("testdata/preprocessor/in/{filename}");
// //   let mut context = super::Context::new();
// //   //   let text = super::process_str(
// //   //     "#define
// //   //     &mut context,
// //   //   )
// //   //   .unwrap();
